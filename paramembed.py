...
class ParamEmbed(nn.Module):
    def __init__(self, nparams, dim, hidden_norm, dropout):
        ...
        nn.init.xavier_normal_(self.lin1.weight, gain=nn.init.calculate_gain("relu"))
        ...
        nn.init.xavier_normal_(self.lin2.weight, gain=nn.init.calculate_gain("relu"))
        if hidden_norm == "nn.BatchNorm1d":
        ...
        nn.init.xavier_normal_(self.lin3.weight, gain=nn.init.calculate_gain("relu"))
